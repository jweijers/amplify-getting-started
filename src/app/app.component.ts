...
import {Pizza} from '../types/pizza/pizza';

const apiName = 'weijerspizza'; // replace with the name of your API
const path = '/weijers/pizza'; // replace with the name of the path of your resource
